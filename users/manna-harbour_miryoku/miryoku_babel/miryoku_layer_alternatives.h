...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_SCRL,           DRAG_SCROLL,       DRAG_SCROLL,       DRAG_SCROLL,       DRAG_SCROLL,           \
KC_WH_L,           KC_WH_U,           KC_WH_D,           KC_WH_R,           U_NA,              KC_PAUS,           TD(U_TD_U_MOUSE),  TD(U_TD_U_SYM),    KC_ALGR,           U_NA,              \
